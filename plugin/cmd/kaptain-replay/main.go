// kaptain-replay scores a recorded snapshot outside kube-scheduler, so a comparison is of
// the decision alone and not of two views of the cluster. The decider's twin is POST /replay.
package main
...
// readSnapshot accepts a bare snapshot or a fixture wrapping one.
