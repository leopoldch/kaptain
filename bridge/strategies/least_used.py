...
class LeastUsed(SchedulingStrategy):
    """Ranks on measured free CPU and memory rather than on requests.

    This is the BT arm of the protocol: it separates the benefit of observing more
    resources from the benefit of learning, so it must see exactly the telemetry a learned
    model would see.
    """
